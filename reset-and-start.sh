...
echo "🚀 Starting Bakery App with Fresh Data Setup..."
...
# Run database reset (this will delete all data and apply migrations)
...
echo "✅ Setup complete! The app should be running with fresh data at:"
